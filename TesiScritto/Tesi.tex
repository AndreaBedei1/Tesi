...
{\color[HTML]{000000} 4} & {\color[HTML]{000000} \begin{tabular}[c]{@{}c@{}}Operazioni statistiche\end{tabular}} & {\color[HTML]{000000} 3/giorno} \\ \hline
\end{tabular}%
}
...
\caption{Tabella degli accessi per la registrazione di un nuovo avvistamento.}
\label{table:tblaccperregnuovavv}
\end{table}

\item Operazioni statistiche:\\
Per semplicità omettiamo lo schema di navigazione. L'operazione statistica che si è deciso di rappresentare è quella della rappresentazione della distribuzione dei delfini. In particolare il numero di avvistamenti di ciascuna specie di delfino. Riportiamo la tabella \ref{table:tblaccperoprstat} degli accessi.
...
{\color[HTML]{000000} 4} & {\color[HTML]{000000} 206.66L = 206.66} & {\color[HTML]{000000} 3/giorno} & 620/giorno \\ \hline
\end{tabular}%
}
...
\hline
\rowcolor[HTML]{C0C0C0} 
{\color[HTML]{000000} Libreria/Tool} & {\color[HTML]{000000} Utilizzo} \\ \hline
{\color[HTML]{000000} AJAX} & {\color[HTML]{000000} Comunicazione asincrona col server remoto} \\ \hline
{\color[HTML]{000000} PHPMailer} & {\color[HTML]{000000} Recupero delle credenziali via mail} \\ \hline
{\color[HTML]{000000} LeafLet} & {\color[HTML]{000000} Visualizzazione di mappe con marker nei luoghi degli avvistamenti} \\ \hline
\end{tabular}%
}
...
Nel progetto sono state utilizzate le seguenti librerie esterne, tabella \ref{table:libestusateappmobile}:\\
\begin{table}[hbtp]
\resizebox{\columnwidth}{!}{%
\begin{tabular}{|c|c|}
\hline
\rowcolor[HTML]{C0C0C0} 
{\color[HTML]{000000} Nome Libreria}               & {\color[HTML]{000000} Utilizzo}                                                                \\ \hline
{\color[HTML]{000000} Datastore-Preferences} &
  {\color[HTML]{000000} \begin{tabular}[c]{@{}c@{}}Implementazione di DataStore per la memorizzazione\\  dei dati di preferenza\end{tabular}} \\ \hline
{\color[HTML]{000000} Leaflet}                     & {\color[HTML]{000000} Libreria JavaScript per la visualizzazione di mappe interattive}         \\ \hline
{\color[HTML]{000000} Biometric \cite{Biometric}}  & {\color[HTML]{000000} Supporto per l'autenticazione biometrica su Android}                     \\ \hline
{\color[HTML]{000000} Play-services-location}      & {\color[HTML]{000000} API di localizzazione di Google Play Services}                           \\ \hline
{\color[HTML]{000000} Room \cite{Room}}            & {\color[HTML]{000000} Libreria di persistenza di dati locali basata su SQLite}                 \\ \hline
{\color[HTML]{000000} Okhttp3 \cite{Okhttp}}       & {\color[HTML]{000000} Libreria per richieste HTTPS su Android}                                 \\ \hline
{\color[HTML]{000000} Castle \cite{Castle}}        & {\color[HTML]{000000} Libreria crittografica per Java}                                         \\ \hline
{\color[HTML]{000000} \begin{tabular}[c]{@{}c@{}}Gson \cite{Gson}\end{tabular}} &
  {\color[HTML]{000000} \begin{tabular}[c]{@{}c@{}}Libreria per la conversione di oggetti Java\\ in formato JSON e viceversa\end{tabular}} \\ \hline
{\color[HTML]{000000} Coil \cite{Coil}}            & {\color[HTML]{000000} Libreria per il caricamento e la visualizzazione di immagini su Android} \\ \hline
{\color[HTML]{000000} Tehras-charts \cite{Tehras}} & {\color[HTML]{000000} Libreria di grafici per Android}                                         \\ \hline
\end{tabular}%
}
\caption{Librerie esterne utilizzate nell'applicazione mobile.}
\label{table:libestusateappmobile}
\end{table}
...
\caption{Risultati sul training e sul validation set.}
\label{table:asdew}
\end{table}
\newpage
...
\bibitem{LAMP} LAMP Applications, Ubuntu server, ubuntu.com
\bibitem{Apache} Apache, Apache HTTP Server Documentation, httpd.apache.org/docs
\bibitem{MySQL} MySQL, dev.mysql.com/doc/
\bibitem{PHP} PHP, www.php.net/docs.php
\bibitem{phoenixnap} Jason Potter, Featured Articles, www.liquidweb.com, March 3 2021
\bibitem{HTML} HTML, HTML Tutorial, www.w3schools.com/html/default.asp
\bibitem{Certbot} Certbot, eff-certbot.readthedocs.io/en/stable/
\bibitem{Let's encrypt} Let's encrypt, letsencrypt.org/docs/
\bibitem{CSS} CSS, CSS Tutorial, www.w3schools.com/css/default.asp
\bibitem{Bootstrap} Bootstrap, Introduction, getbootstrap.com
\bibitem{JavaScript} JavaScript, Introduction, getbootstrap.com
\bibitem{JQUERY} jQuery, jQuery API, api.jquery.com
\bibitem{javascript-coder} javascript-coder, Reintroduction To AJAX, www.javascript-coder.com.
\bibitem{AJAX} AJAX, AJAX Introduction, www.w3schools.com/xml/ajax\_intro.asp
\bibitem{JSON} JSON, Introducing JSON, www.json.org/json-en.html
\bibitem{Mailer} PHPmailer, github.com/PHPMailer/PHPMailer
\bibitem{Leaflet} Leaflet, leafletjs.com/reference.html
\bibitem{okta} Jason Jung, Password Hashing and Salting, www.okta.com, May 7 2021
\bibitem{W3C} W3C, W3C standards and drafts, www.w3.org/TR/
\bibitem{WCAG} WCAG, The WCAG 2 Documents, www.w3.org/WAI/standards-guidelines/wcag/docs/
\bibitem{antonio} Antonio Giovanni Schiavone, Accessibilità, www.antoniogiovannischiavone.it, 1 Settembre 2016.
\bibitem{Android} Android, Guide per gli sviluppatori, developer.android.com/docs?hl=it
\bibitem{Kotlin} Kotlin, Kotlin docs, kotlinlang.org/docs/home.html
\bibitem{Compose} Jetpack Compose, m3.material.io/develop/android/jetpack-compose
\bibitem{Material} Material Design, m3.material.io
\bibitem{Java} Java, Java documentation, docs.oracle.com/en/java/
\bibitem{Biometric} Biometric, developer.android.com/jetpack/androidx/releases/biometric
\bibitem{Room} Room, developer.android.com/jetpack/androidx/releases/room
\bibitem{Okhttp} Okhttp3, Package Okhttp3, javadoc.io/doc/com.squareup.okhttp3/okhttp/3.14.9/okhttp3/\\package-summary.html
\bibitem{Castle} Castle, An Introduction to Castle, docs.castle.io/docs
\bibitem{Gson} Gson, Class GSON, www.javadoc.io/doc/com.google.code.gson/gson/2.8.0/com/\\google/gson/Gson.html
\bibitem{Coil} Coil, coil-kt.github.io/coil/
\bibitem{Tehras} Tehras-charts, github.com/tehras/charts
\bibitem{pinnaDelf} Renò, V.; Losapio, G.; Forenza, F.; Politi, T.; Stella, E.; Fanizza, C.; Hartman, K.; Carlucci, R.; Dimauro, G.; Maglietta, R. Combined Color Semantics and Deep Learning for the Automatic Detection of Dolphin Dorsal Fins. Electronics 2020, 9, 758. https://doi.org/10.3390/electronics9050758
\bibitem{mobileNet} MobileNetV2, Google, TensorFlow, github.com/tensorflow/models/tree/master/research/slim/nets/mobilenet
\bibitem{imageNet} Deng, J., Dong, W., Socher, R., Li, L. J., Li, K., \& Fei-Fei, L. (2009). ImageNet: A large-scale hierarchical image database. Stanford University. image-net.org/
\bibitem{dataset} Happywhale. (2022). Happywhale - Whale and Dolphin Identification. Kaggle. www.kaggle.com/competitions/happy-whale-and-dolphin/data
\bibitem{numpy} NumPy, NumPy documentation, numpy.org/doc/
\bibitem{matplotlib} Matplotlib, Matplotlib 3.7.1 documentation, matplotlib.org/stable/index.html
\bibitem{pathlib} Pathlib, Pathlib 3.4 documentation, docs.python.org/3/library/pathlib.html
\bibitem{pandas} pandas, pandas documentation, pandas.pydata.org/docs/
\bibitem{seaborn} seaborn, seaborn: statistical data visualization, seaborn.pydata.org
\bibitem{tensorflow} TensorFlow, API Documentation, www.tensorflow.org/api\_docs
\bibitem{scikit} scikit-learn, scikit-learn.org/stable
