...
\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.7]{img_concettuale/avvistamento1.png}
\caption{Schema concettuale per la modellazione degli avvistamenti e delle proprietà dell'utente.}
\end{figure}

Come mostrato in figura sono presenti uno o più utenti, ognuno dei quali accedono alla piattaforma attraverso la propria email e password. Di tale utente possiamo tenere anche in considerazione il proprio nome e cognome.
...
In aggiunta per ogni avvistamento è associata una coordinata geografica la quale tiene in considerazione la longitudine e la latitudine al momento dell'inserimento.

\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.7]{img_concettuale/avvistamento2.png}
...
\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.8]{img_concettuale/avvistamento3.jpg}
...
\item Un discorso simile viene fatto per l'entità Coordinata\_Geografica, la quale per motivi di gestione (mantenimento e controllo delle varie aree geografiche), si è deciso di mantenerla separata dall'entità avvistamento.   
\end{itemize}
...
\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.7]{img_concettuale/ER.jpg}
...
Coordinata\_Geografica & E & 100 \\ \hline
...
Coordinata\_Geografica & \multicolumn{1}{c|}{E} & \multicolumn{1}{c|}{1} & S \\ \hline
...
Esemplare & \multicolumn{1}{c|}{E} & \multicolumn{1}{c|}{4} & S \\ \hline
 & \multicolumn{3}{c|}{Totale = 12.5S + 5L} \\ \hline
\end{tabular}%
}
\end{table}
...
\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.73]{img_concettuale/Logico.jpg}
...
\textbf{Criterio di copertura delle decisioni e delle condizioni:} selezionare un insieme di test T tali che, a seguito dell’esecuzione del programma P su tutti i casi di T, ogni arco del grafo di controllo di P sia attraversato e tutti i possibili valori delle condizioni composte siano valutati almeno una volta.\cite{2}
\\
