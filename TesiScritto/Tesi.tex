...
\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.40]{img_concettuale/wcag.png}
...
\caption{Pagine delle impostazioni del profilo utente.}
\end{figure}
...
In aggiunta in tutte le pagine del sito al fine di migliorare l'accessibilità e la facilità di utilizzo sono stati aggiunti attributi "placeholder" ai tag di input, i quali indicano all'utente le informazioni richieste. Inoltre, ai pulsanti il cui scopo non è chiaramente indicato è stato aggiunto l'attributo "aria-label" per specificare lo scopo del pulsante.\\ Infine, viene mostrata come viene modificata la pagina in modalità tablet o smartphone.
\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.61]{img_concettuale/impostazioniSec.png}
\caption{Pagine delle impostazioni sulla sicurezza in modalità mobile.}
\end{figure}
...
Vicino alla specie è presente un pulsante a forma di punto interrogativo, quel pulsante aiuta l'utente a individuare la specie, fornendo informazioni dettagliate sull'elemento scelto.  
Il pulsante "salva" invece permette di salvare le informazioni inserite negli input, invece il bottone "+Immgine" permette di aggiungere un immagine all'avvistamento. Per evitare errori involontari, viene sempre visualizzato un modale di conferma prima di eliminare un avvistamento.
\begin{figure}[hbtp]
\centering
...
\caption{Seconda parte della pagina dell'avvistamento, caratteristiche esemplari.}
\end{figure}
\\Nella seguente pagina è presente un carosello che permette di visualizzare tutte le foto dell'avvistamento, in caso siano state caricate più immagini a destra e a sinistra dell'immagine compariranno due bottoni per navigare la galleria. E' presente un bottone elimina sotto all'immagine il quale eliminerà non solo l'immagine ma anche tutti i riferimenti ad essa associati.
Ad ogni immagine c'è la possibilità di aggiungere un esemplare attraverso il relativo bottone, il quale una volta premuto attraverso un modale permetterà di disegnare dei rettangoli per individuare l'individuo. L'id dell'individuo, cioè della sottoimmagine è univoco all'interno della stessa foto. A ciascun individuo si ha la possibilità si associargli un nome oppure se si riconosce che si tratti di un esemplare già incontrato si ha la possibilità di selezionarlo. Come negli altri casi anche qui è presente la funzione di eliminazione di un esemplare. A ciascuno di essi possono essere associate una o più ferite, una volta individuate e scelto l'esemplare di riferimento possono essere aggiunte grazie al relativo pulsante e nel caso anche modificate e cancellate.\\
Un esempio di aggiunta di un individuo può essere questo:  
\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.42]{img_concettuale/addEsempl.png}
\caption{Modale con canvas per disegnare l'individuo.}
\end{figure}
\\Invece per quanto riguarda la modifica dell'individuo si ha questo modale:
\begin{figure}[hbtp]
\centering
